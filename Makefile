.PHONY: paper-assets verify-paper submission paper-pdf overleaf-package arxiv-package arxiv-preflight icprs-pdf icprs-package clean-paper-assets
...
icprs-pdf:
	cp paper/references.bib paper/icprs/references.bib
